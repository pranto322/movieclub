      ...
      <nav className="bg-white border-b-2 border-gray-200 px-2 sm:px-4 py-2 dark:bg-gray-900 dark:border-b-1 dark:border-gray-900">
        <div className="flex flex-wrap justify-between items-center mx-auto">
          <Link to="/" className="flex justify-center">
              <span>
                <img className ="h-12 transition-all duration-300 rounded-lg cursor-pointer filter grayscale hover:grayscale-0" src={Logo} alt="MovieInfo Logo"/>
              </span>
              <span className="self-center ml-2 text-2xl font-semibold whitespace-nowrap dark:text-white">MovieClub</span>
          </Link>
